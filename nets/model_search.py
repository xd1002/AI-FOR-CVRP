...
class AttentionModel(nn.Module):
    ...
    def forward(self, input, opts=None, baseline=None, bl_val=None, n_EG=None, return_pi=False, return_kl=False, beam_size=None, fst=None):
        ...
        if self.is_vrp and n_EG:
            ...
            n_EG = self.n_EG
        # embeddings_init: batch_size x graph_size+n_agent+n_depot x embed_dim
        # init_context: batch_size x embedding_dim
        # attn: n_heads x batch_size x graph_size+n_depot+n_agent x graph_size+n_depot+n_agent
        # v: n_heads x batch_size x graph_size+n_depot+n_agent x val_dim(embed_dim/n_heads)
        # h_old: batch_size x graph_size+n_depot+n_agent x embed_dim
